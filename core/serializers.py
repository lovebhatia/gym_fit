...
class ExerciseDataListSerializer(serializers.ModelSerializer):
    class Meta:
        model = ExerciseDataList
        fields = '__all__'
...
class WorkoutSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Workout
        fields = ['id', 'user', 'name', 'date', 'exercises']
...
class ExerciseDaySerializer(serializers.ModelSerializer):
    exerciseDataList = ExerciseDataListSerializer(many = True, read_only = True)
...
class BMIRecordSerializer(serializers.ModelSerializer):
    class Meta:
        model = BMIRecord
        fields = ['id', 'user', 'date', 'sex', 'height', 'weight', 'age', 'bmi']